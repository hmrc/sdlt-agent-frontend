...
sealed trait ConfirmAgentContactDetails

object ConfirmAgentContactDetails extends Enumerable.Implicits {

  case object Option1 extends WithName("true") with ConfirmAgentContactDetails
