...
import pages.manageAgents.{AgentAddressDetails, AgentNameDuplicateWarningPage, AgentNamePage}
      ...
      .fold(
        ...
        value =>
          for {
            ...
            Redirect(navigator.nextPage(AgentAddressDetails, mode, updatedAnswers))
          }
      )
  }
}
