  ...
  "AddressLookupController get AL journey result" - {
    ...
    "return AddressDetails on success: NormalMode" in new Fixture {
      ...
      running(app) {
        ...
        status(result) mustEqual SEE_OTHER
        redirectLocation(result).value mustEqual "/stamp-duty-land-tax-agent/manage-agents/do-you-want-to-add-contact-details"
    ...
    "return AddressDetails on success: CheckMode" in new Fixture {
      ...
      running(app) {
        ...
        status(result) mustEqual SEE_OTHER
        redirectLocation(result).value mustEqual "/stamp-duty-land-tax-agent/manage-agents/check-answers"
